...
#define REQUIRED_CONSECUTIVE_FRAMES 2 //new persistence variable, may need to increase this
...
void fftloop() {
  ...
  if (millis() - windowStart >= 5000) {
    Serial.print("avg_ratio_x1000:");
    Serial.print((ratioSum / frameCount) * 1000);
    Serial.print(" ");
    Serial.print("max_ratio_x1000:");
    Serial.print(ratioMax * 1000);
    Serial.print(" ");
    Serial.print("avg_global_freq:");
    Serial.print(globalFreqSum / frameCount);
    Serial.print(" ");
    Serial.print("avg_target_freq:");
    Serial.print(targetFreqSum / frameCount);
    Serial.print(" ");
    Serial.print("hits:");
